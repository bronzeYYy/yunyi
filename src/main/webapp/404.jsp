...
<div style="margin-top:50px;" class="text-center">
	<button style="margin-right: 5%; background-color: #75AF74" class="select" onclick="window.location='user'">个人中心</button>
	<button style="margin-left: 5%; background-color: #0074E8" class="select" onclick="window.location='column'">返回首页</button>
</div>
</body>
</html> 