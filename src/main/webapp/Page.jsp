		...
		<div class="container">
			...
			<div id="navbar" class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a class="scroll" href="Page_stu.jsp" id="test">专栏</a></li>
					<li class="active"><a class="scroll" href="#" id = "yuan">发现</a></li>
					<li class="active"><a class="scroll" href="#" id ="wenjian">联系我们</a></li>
					<li class="active"><a class="scroll" href="#" id ="wenjian">我的主页</a></li>
				</ul>
	...
	<div style="width:100%;background-color:#141415">
		...
		<div class="footer_grids">
			...
			<div class="col-md-4 footer_grid" style="margin-top:60px">
				...
				<h1>问题${i.questionName }</h1><h4>创建时间${i.creationTime }</h4>
			...
			<div class="col-md-4 footer_grid" style="margin-top:60px;margin-left:300px">
				...
				<div style="margin-top:20px;bgcolor:#ffff00" >
					 <c:forEach var="i" items="${questions}">
				<div style="bgcolor:#F00000">
				<h1>资料名${i.questionName }</h1><h4>创建时间${i.creationTime }</h4>
				<p><h3>内容${i.questionContent }</h3></p>
				<hr>
				</div>
				</c:forEach>			
				</div>	
